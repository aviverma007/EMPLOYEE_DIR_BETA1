...
const AppContent = () => {
  ...
  return (
    <div className="App min-h-screen bg-blue-50 dark:bg-[#333333]">
      <BrowserRouter>
        <Routes>
          <Route path="/" element={
              ...
              <div className="flex-1 w-full px-2 sm:px-4 lg:px-6 py-4">
                <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full h-full flex flex-col">
                  ...
                  <div className="flex justify-start mb-4 overflow-x-auto">
                    <TabsList className="flex w-auto h-10 shadow-md border rounded-lg p-1 min-w-max bg-white dark:bg-[#404040] border-blue-200 dark:border-gray-600">
                      <TabsTrigger 
                        value="home" 
                    ...
                    <TabsContent value="admin-dashboard" className="mt-0 h-full">
                      <div className="space-y-4">
                        ...
                        <Tabs defaultValue="banner" className="w-full">
                          <TabsList className="grid w-full grid-cols-2 dark:bg-[#404040]">
                            <TabsTrigger value="banner" className="dark:data-[state=inactive]:text-gray-300">Banner Management</TabsTrigger>
                            <TabsTrigger value="employee" className="dark:data-[state=inactive]:text-gray-300">Employee Management</TabsTrigger>
                          </TabsList>
